import svgPaths from "./svg-zomj3rnwv7";
...
import { imgContents, imgFlag } from "./svg-gyzxj";
    ...
    <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[32px_24px]" data-name="contents" style={{ maskImage: `url('${imgContents}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.4286 21.4286">
        <g id="contents">
          ...
          <mask height="22" id="mask0_11_26254" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="22" x="0" y="0">
            <path clipRule="evenodd" d="M0 0V21.4286H21.4286V0H0Z" fill="var(--fill-0, white)" fillRule="evenodd" id="background_2" />
          </mask>
          <g mask="url(#mask0_11_26254)">
            ...
            <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[32px_24px]" data-name="contents" style={{ maskImage: `url('${imgFlag}')` }}>
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 24">
                <g id="contents">
                  ...
                  <mask height="24" id="mask0_11_26184" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="32" x="0" y="0">
                    <path clipRule="evenodd" d="M0 0V24H32V0H0Z" fill="var(--fill-0, white)" fillRule="evenodd" id="background_2" />
                  </mask>
                  <g mask="url(#mask0_11_26184)">
...
function Avatar() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-center relative shrink-0 w-full" data-name="Avatar">
      <Content1 />
      <Text />
    </div>
  );
...
function Content() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col items-center left-1/2 px-[16px] top-[130px] w-[393px]" data-name="Content">
      <Avatar />
    </div>
  );
}

export default function InvestorProfileAgent() {
  return (
    <div className="bg-white relative size-full" data-name="Investor profile (Agent)">
