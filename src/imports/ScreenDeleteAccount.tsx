import svgPaths from "./svg-896kk7oyp0";
...
function Section() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] items-center left-[17px] top-[137px] w-[360px]" data-name="Section">
...
export default function ScreenDeleteAccount() {
  return (
    <div className="bg-white relative size-full" data-name="Screen / Delete_Account">
      <Header />
      <Section />
      <AccountActions />
    </div>
