import svgPaths from "./svg-opai1fuyun";
...
import imgRectangle13 from "@/assets/0c3689ca7c633cead2c0fa90f36467c999781bf9.png";
import { imgFlag } from "./svg-mvexn";
...
function Frame17() {
  return (
    <div className="content-stretch flex font-['TT_Commons:Medium',sans-serif] gap-[12px] items-start leading-none not-italic relative shrink-0 text-[16px] w-full">
      <p className="relative shrink-0 text-[#050b2e]">Proposal message</p>
      <p className="flex-[1_0_0] min-h-px min-w-px relative text-[#01cbd2] text-right whitespace-pre-wrap">AI ENHANCE</p>
    </div>
  );
}
...
function Name1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Name">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Name">
        <p className="font-['TT_Commons:Medium',sans-serif] leading-none not-italic relative shrink-0 text-[#050b2e] text-[16px]">Dubai Marina, UAE</p>
      </div>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[12px] top-[142px] w-[337px]">
      <Frame1 />
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="bg-white h-[193px] relative rounded-[12px] shrink-0 w-full">
      <Frame3 />
      <div className="absolute h-[124px] left-0 rounded-tl-[12px] rounded-tr-[12px] top-[-0.32px] w-[361px]">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-tl-[12px] rounded-tr-[12px]">
          <img alt="" className="absolute h-[236.3%] left-[-28.23%] max-w-none top-[-45.9%] w-[145.04%]" src={imgRectangle13} />
        </div>
      </div>
    </div>
  );
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[16px] top-[126px] w-[410px]">
      <Frame15 />
      <Frame16 />
      <Frame18 />
      <Frame13 />
...
function Button() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#01cbd2] content-stretch flex gap-[4px] h-[44px] items-center justify-center left-1/2 p-[10px] rounded-[24px] top-[857px] w-[361px]" data-name="Button">
...
export default function IPhone1415Pro() {
  return (
    <div className="bg-white relative size-full" data-name="iPhone 14 & 15 Pro - 17">
