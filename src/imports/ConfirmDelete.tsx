import svgPaths from "./svg-75zbtw12u8";
...
function Title1() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-center relative shrink-0 w-full" data-name="Title">
      ...
      <p className="font-['TT_Commons:Regular',sans-serif] leading-none min-w-full not-italic relative shrink-0 text-[#050b2e] text-[21px] text-center w-[min-content] whitespace-pre-wrap">Delete Account</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col font-['TT_Commons:Regular',sans-serif] gap-[9px] items-start leading-[0] not-italic relative shrink-0 text-[#050b2e] text-[16px] w-full whitespace-pre-wrap">
      <div className="relative shrink-0 w-full">
        <p className="leading-none mb-0">Are you sure you want to delete your account?</p>
        <p className="leading-none mb-0">You will permanently lose your:</p>
        <ul className="list-disc">
          <li className="mb-0 ms-[24px]">
            <span className="leading-none">profile</span>
          </li>
          <li className="mb-0 ms-[24px]">
            <span className="leading-none">photos</span>
          </li>
      ...
      <p className="relative shrink-0 text-[0px] w-full">
        <span className="leading-none">{`Type "`}</span>
        <span className="font-['TT_Commons:Medium',sans-serif] leading-none text-[#01cbd2]">delete account</span>
        <span className="leading-none">{`" to confirm.`}</span>
      </p>
    </div>
  );
}
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[10px] relative size-full">
          <p className="font-['TT_Commons:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#666] text-[0px] text-[16px] text-center">
            ...
            <span className="leading-none">delete account</span>
          </p>
        </div>
      </div>
    </div>
