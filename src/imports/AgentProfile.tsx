...
function Profile() {
  return (
    <div className="absolute inset-[5.21%_17.71%_9.38%_17.71%]" data-name="Profile 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.6667 27.3333">
        <g id="Profile 1">
          <g id="Vector">
            <path clipRule="evenodd" d={svgPaths.p1d8b0700} fill="var(--fill-0, #050B2E)" fillRule="evenodd" />
            <path clipRule="evenodd" d={svgPaths.p7cc5880} fill="var(--fill-0, #050B2E)" fillRule="evenodd" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame34() {
  return (
    <div className="content-stretch flex h-full items-center relative shrink-0">
      <div className="relative shrink-0 size-[32px]" data-name="Duseat-icons-24PT-Profile 1">
        <Profile />
      </div>
    </div>
  );
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start leading-none min-h-px min-w-px not-italic relative">
      <p className="font-['TT_Commons:Medium',sans-serif] min-w-full relative shrink-0 text-[#050b2e] text-[21px] w-[min-content] whitespace-pre-wrap" dir="auto">
        View profile
      </p>
      <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] text-center">Add this request to your favourite requests</p>
    </div>
  );
}
...
function Bookmark() {
  return (
    <div className="absolute inset-[9.37%_17.71%_6.66%_17.71%]" data-name="Bookmark 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.6669 26.8689">
        <g id="Bookmark 1">
          <path clipRule="evenodd" d={svgPaths.p1bbd8c00} fill="var(--fill-0, #050B2E)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame32() {
  return (
    <div className="content-stretch flex h-full items-center relative shrink-0">
      <div className="relative shrink-0 size-[32px]" data-name="Duseat-icons-24PT-Bookmark 1">
        <Bookmark />
      </div>
    </div>
  );
...
function Upload() {
  return (
    <div className="absolute inset-[9.38%_9.37%_9.37%_9.37%]" data-name="Upload">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26 26">
        <g id="Upload">
          <g id="Vector">
            <path d={svgPaths.p19e5a00} fill="var(--fill-0, #050B2E)" />
            <path d={svgPaths.p380a27f0} fill="var(--fill-0, #050B2E)" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame31() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start leading-none not-italic relative shrink-0 w-[159px]">
      <p className="font-['TT_Commons:Medium',sans-serif] min-w-full relative shrink-0 text-[#050b2e] text-[21px] w-[min-content] whitespace-pre-wrap">Share the request</p>
      <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] text-center">More of your posts will be like this</p>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full">
      <div className="relative shrink-0 size-[32px]" data-name="Duseat-icons-24PT-Upload">
        <Upload />
      </div>
      <Frame31 />
    </div>
...
function ProfileAdd() {
  return (
    <div className="absolute inset-[5.21%_9.37%_9.37%_13.54%]" data-name="Profile Add 2">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.6667 27.3334">
        <g id="Profile Add 2">
          <g id="Vector">
            <path clipRule="evenodd" d={svgPaths.pf85eb80} fill="var(--fill-0, #050B2E)" fillRule="evenodd" />
            <path d={svgPaths.p1ccf3c00} fill="var(--fill-0, #050B2E)" />
            <path d={svgPaths.p603a80} fill="var(--fill-0, #050B2E)" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame37() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start leading-none not-italic relative shrink-0 w-[159px]">
      <p className="font-['TT_Commons:Medium',sans-serif] min-w-full relative shrink-0 text-[#050b2e] text-[21px] w-[min-content] whitespace-pre-wrap">Investor interested</p>
      <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] text-center">More of your posts will be like this</p>
    </div>
  );
}
...
function Frame35() {
  return (
    <div className="content-stretch flex gap-[7px] items-center relative shrink-0 w-full">
      <div className="relative shrink-0 size-[32px]" data-name="Duseat-icons-24PT-Profile Add 2">
        <ProfileAdd />
      </div>
      <Frame37 />
    </div>
...
function ProfileRemove() {
  return (
    <div className="absolute inset-[5.21%_9.37%_9.37%_13.54%]" data-name="Profile Remove 2">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.6667 27.3334">
        <g id="Profile Remove 2">
          <g id="Vector">
            <path clipRule="evenodd" d={svgPaths.pf85eb80} fill="var(--fill-0, #050B2E)" fillRule="evenodd" />
            <path d={svgPaths.p1ccf3c00} fill="var(--fill-0, #050B2E)" />
            <path d={svgPaths.p1f4b2c80} fill="var(--fill-0, #050B2E)" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame39() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start leading-none not-italic relative shrink-0 w-[159px]">
      <p className="font-['TT_Commons:Medium',sans-serif] min-w-full relative shrink-0 text-[#050b2e] text-[21px] w-[min-content] whitespace-pre-wrap">Report investor</p>
      <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] text-center">More of your posts will be like this</p>
    </div>
  );
}
...
function Frame38() {
  return (
    <div className="content-stretch flex gap-[7px] items-center relative shrink-0 w-full">
      <div className="relative shrink-0 size-[32px]" data-name="Duseat-icons-24PT-Profile Remove 2">
        <ProfileRemove />
      </div>
      <Frame39 />
    </div>
...
function Frame33() {
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[10px] items-start px-[16px] py-[12px] relative w-full">
        <Frame35 />
        <Frame38 />
      </div>
    </div>
...
function DeleteAccount() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f8f8f8] bottom-0 content-stretch flex flex-col gap-[12px] items-center left-1/2 px-[16px] py-[24px] rounded-tl-[16px] rounded-tr-[16px] w-[393px]" data-name="Delete account">
      <Frame36 />
      <Frame27 />
      <Frame26 />
      <Frame33 />
...
function Main() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 top-0" data-name="Main">
      <Header />
      <Search />
    </div>
  );
...
function Requests() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 top-[237.38px]" data-name="Requests">
...
function Frame40() {
  return <div className="absolute backdrop-blur-[2px] bg-[rgba(6,14,60,0.17)] h-[995px] left-0 top-[-47px] w-[393px]" />;
}

function Content() {
  return (
    <div className="absolute h-[861.38px] left-0 top-[46px] w-[393px]" data-name="Content">
      <Main />
      <Requests />
      <Frame40 />
    </div>
...
export default function AgentProfile() {
  return (
    <div className="bg-[#f8f8f8] relative size-full" data-name="Agent profile">
      <DeleteAccount />
      <StatusBar />
      <Content />
    </div>
