import svgPaths from "./svg-2nna3trnrt";
    ...
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-[241px]" data-name="Title">
      ...
      <div className="relative shrink-0 size-[18px]" data-name="Business badge">
        <div className="absolute h-[16.94px] left-[0.41px] top-[0.3px] w-[17.171px]" data-name="Badge">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.1709 16.9397">
            <path d={svgPaths.p1b8b5e20} fill="var(--fill-0, #01CBD2)" id="Badge" />
          </svg>
        </div>
      </div>
    </div>
...
function Plan() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Plan">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Rera verfied">
...
function Left() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[3px] items-end left-[260px] pt-px top-[-1px] w-[32px]" data-name="Left">
...
function Text() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[292px]" data-name="Text">
...
function DocumentDownload() {
  return (
    <div className="absolute inset-[9.37%_9.38%_9.38%_9.37%]" data-name="Document Download 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.5 19.5">
        <g id="Document Download 1">
          <g id="Vector">
            <path d={svgPaths.p2cb509c0} fill="var(--fill-0, white)" />
            <path clipRule="evenodd" d={svgPaths.p27da8100} fill="var(--fill-0, white)" fillRule="evenodd" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame2() {
  return (
    <div className="bg-[#050b2e] content-stretch flex flex-col gap-[4px] h-full items-center justify-center relative rounded-bl-[4px] rounded-tl-[4px] shrink-0 w-[56px]">
      <div className="relative shrink-0 size-[24px]" data-name="Icon 24 swap">
        <div className="absolute inset-0 overflow-clip" data-name="Duseat-icons-24PT-Document Download 1">
          <DocumentDownload />
        </div>
      </div>
      <p className="font-['TT_Commons:Medium',sans-serif] leading-none not-italic relative shrink-0 text-[12px] text-white">Archive</p>
    </div>
  );
}
...
function Pin() {
  return (
    <div className="absolute inset-[5.21%_12.57%_6.36%_9.67%]" data-name="Pin">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.6611 21.2236">
        <g id="Pin">
          <path clipRule="evenodd" d={svgPaths.pef11600} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame3() {
  return (
    <div className="bg-[#01cbd2] content-stretch flex flex-col gap-[4px] h-full items-center justify-center relative rounded-br-[4px] rounded-tr-[4px] shrink-0 w-[56px]">
      <div className="relative shrink-0 size-[24px]" data-name="Icon 24 swap">
        <div className="absolute inset-0 overflow-clip" data-name="Duseat-icons-24PT-Pin">
          <Pin />
        </div>
      </div>
      <p className="font-['TT_Commons:Medium',sans-serif] leading-none not-italic relative shrink-0 text-[12px] text-white">Pin</p>
    </div>
  );
}
...
function MentionBadge() {
  return (
    <div className="content-stretch flex gap-[6px] items-start relative shrink-0" data-name="Mention + Badge">
      <div className="bg-[#01cbd2] content-stretch flex flex-col items-center justify-center p-[4px] relative rounded-[24px] shrink-0 size-[20px]" data-name="Counter">
...
function Content() {
  return (
    <div className="content-stretch flex flex-col gap-[27px] h-[627px] items-center overflow-x-clip overflow-y-auto relative shrink-0 w-[369px]" data-name="Content">
      <Filters />
      <div className="bg-[rgba(255,255,255,0.19)] content-stretch flex gap-[8px] items-center justify-end relative shrink-0 w-[361px]" data-name="Investor User card">
      ...
      <div className="content-stretch flex gap-[8px] items-center justify-end relative shrink-0 w-[361px]" data-name="User card">
        <div className="relative shrink-0 size-[56px]" data-name="Investor Avatar Card">
...
function Frame() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] flex-col gap-[19px] items-center min-h-px min-w-px relative w-[393px]">
...
export default function ChatListScrollToLeft() {
  return (
    <div className="bg-[#01cbd2] content-stretch flex flex-col items-start overflow-clip relative rounded-[24px] size-full" data-name="Chat-list [Scroll to Left]">
      <Top />
      <Frame />
    </div>
  );
