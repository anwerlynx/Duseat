import svgPaths from "./svg-xw699t49ex";
        ...
        <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Message type">
          <div className="absolute h-[14.6px] left-[2.9px] top-px w-[10.199px]" data-name="Ico">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.1992 14.5996">
              <path d={svgPaths.pa4a0e80} fill="var(--fill-0, #CCCCCC)" id="Ico" />
            </svg>
          </div>
        </div>
        <div className="overflow-clip relative shrink-0 size-[19px]" data-name="Check mark">
          <div className="absolute h-[10.601px] left-px top-[4px] w-[16.267px]" data-name="Ico">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.2665 10.5998">
              <path d={svgPaths.pccf9700} fill="var(--fill-0, #767779)" id="Ico" />
            </svg>
          </div>
        </div>
        <p className="flex-[1_0_0] font-['TT_Commons:Regular',sans-serif] leading-none min-h-px min-w-px not-italic overflow-hidden relative text-[#ccc] text-[14px] text-ellipsis tracking-[-0.14px] whitespace-pre-wrap">0:25</p>
      </div>
      <Left1 />
    </div>
  );
...
function Text3() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start pb-[8px] relative shrink-0 w-[292px]" data-name="Text">
      ...
      <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-[254px]" data-name="Messages\' preview">
        <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Message type">
          <div className="absolute h-[12px] left-[3px] top-[2px] w-[10px]" data-name="Ico">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 12">
              <path d={svgPaths.p34745200} fill="var(--fill-0, #CCCCCC)" id="Ico" />
            </svg>
          </div>
        </div>
        <div className="overflow-clip relative shrink-0 size-[19px]" data-name="Check mark">
        ...
        <p className="flex-[1_0_0] font-['TT_Commons:Regular',sans-serif] leading-none min-h-px min-w-px not-italic overflow-hidden relative text-[#ccc] text-[14px] text-ellipsis tracking-[-0.14px] whitespace-pre-wrap">File</p>
      </div>
      <Left4 />
    </div>
  );
...
function Main() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] flex-col items-center min-h-px min-w-px py-[12px] relative w-[393px]" data-name="Main">
      <Content />
    </div>
  );
}

export default function ChatListMainMix() {
  return (
    <div className="bg-[#01cbd2] content-stretch flex flex-col items-start overflow-clip relative rounded-[24px] size-full" data-name="Chat-list [main mix ]">
      <Top />
      <Main />
    </div>
  );
