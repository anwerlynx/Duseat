import svgPaths from "./svg-fm7jjgzdj6";
...
function TickCircle() {
  return (
    <div className="absolute inset-[5.21%]" data-name="Tick Circle">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.5 21.5">
        <g id="Tick Circle">
          <g id="Vector">
            <path d={svgPaths.p1fd14900} fill="url(#paint0_linear_8_1501)" />
            <path clipRule="evenodd" d={svgPaths.p3032e272} fill="url(#paint1_linear_8_1501)" fillRule="evenodd" />
          </g>
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_8_1501" x1="10.75" x2="10.75" y1="0" y2="21.5">
            <stop stopColor="#060E3C" />
            <stop offset="1" stopColor="#01C4CB" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_8_1501" x1="10.75" x2="10.75" y1="0" y2="21.5">
            <stop stopColor="#060E3C" />
            <stop offset="1" stopColor="#01C4CB" />
          </linearGradient>
        </defs>
...
function FreeGradientInterfaceEssentialStar2RewardRatingRateSocialStarMediaFavoriteLikeStarsSpark() {
  return (
    <div className="bg-[#ccfdff] content-stretch flex flex-col items-center justify-center relative rounded-[28px] shrink-0 size-[48px]" data-name="Free Gradient/Interface Essential/star-2--reward-rating-rate-social-star-media-favorite-like-stars-spark">
      <div className="relative shrink-0 size-[24px]" data-name="Icon 24 swap">
        <div className="absolute inset-0 overflow-clip" data-name="Duseat-icons-24PT-Tick Circle">
          <TickCircle />
        </div>
      </div>
    </div>
...
function Frame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[5px] items-start justify-center leading-none min-h-px min-w-px not-italic relative">
      <p className="font-['TT_Commons:Medium',sans-serif] relative shrink-0 text-[#050b2e] text-[21px]">{`Complete Profile `}</p>
      <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#666] text-[16px]">Unlock advanced features</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="bg-[#060e3c] content-stretch flex items-center justify-center p-[10px] relative rounded-[9999px] shrink-0">
      <p className="font-['TT_Commons:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[16px] text-center text-white">Complete</p>
    </div>
  );
}
...
function FreeGradientInterfaceEssentialStar2RewardRatingRateSocialStarMediaFavoriteLikeStarsSpark1() {
  return (
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[5px] items-start justify-center leading-none min-h-px min-w-px not-italic relative">
      <p className="font-['TT_Commons:Medium',sans-serif] relative shrink-0 text-[#050b2e] text-[21px]">Upgrade to Plus</p>
      <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#666] text-[16px]">Unlock advanced features</p>
    </div>
  );
}
    ...
    <div className="bg-white relative rounded-[24px] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.24)] shrink-0 w-full">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[12px] items-center p-[12px] relative w-full">
          ...
          <FreeGradientInterfaceEssentialStar2RewardRatingRateSocialStarMediaFavoriteLikeStarsSpark1 />
          <Frame4 />
          <Frame5 />
        </div>
      </div>
...
function UserTag() {
  return (
    <div className="absolute inset-[5.21%_9.38%_8.89%_9.37%]" data-name="User Tag">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.5 20.6159">
        <g id="User Tag">
          <g id="Vector">
            <path clipRule="evenodd" d={svgPaths.p39468800} fill="var(--fill-0, #333333)" fillRule="evenodd" />
            <path clipRule="evenodd" d={svgPaths.pdc4fa00} fill="var(--fill-0, #333333)" fillRule="evenodd" />
          </g>
        </g>
      </svg>
    </div>
...
function Label() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Label">
      <div className="relative shrink-0 size-[24px]" data-name="Icon 24 swap">
        <div className="absolute inset-0 overflow-clip" data-name="Duseat-icons-24PT-User Tag">
          <UserTag />
        </div>
      </div>
      <p className="font-['TT_Commons:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#050b2e] text-[21px] text-center">Personal information</p>
    </div>
  );
}
...
function Unlock() {
  return (
    <div className="absolute inset-[5.21%_9.37%]" data-name="Unlock 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.5001 21.5">
        <g id="Unlock 1">
          <g id="Vector">
            <path clipRule="evenodd" d={svgPaths.p12af4600} fill="var(--fill-0, #333333)" fillRule="evenodd" />
            <path clipRule="evenodd" d={svgPaths.p2a48d180} fill="var(--fill-0, #333333)" fillRule="evenodd" />
          </g>
        </g>
      </svg>
    </div>
...
function Label2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Label">
      <div className="relative shrink-0 size-[24px]" data-name="Icon 24 swap">
        <div className="absolute inset-0 overflow-clip" data-name="Duseat-icons-24PT-Unlock 1">
          <Unlock />
        </div>
      </div>
      <p className="font-['TT_Commons:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#050b2e] text-[21px] text-center">Privacy</p>
    </div>
  );
}
...
function Link() {
  return (
    <div className="absolute inset-[26.04%_9.38%]" data-name="Link">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.5 11.5">
        <g id="Link">
          <g id="Vector">
            <path d={svgPaths.p1f761840} fill="var(--fill-0, #333333)" />
            <path d={svgPaths.p2725e800} fill="var(--fill-0, #333333)" />
            <path d={svgPaths.p29c34280} fill="var(--fill-0, #333333)" />
          </g>
        </g>
      </svg>
    </div>
...
function Label3() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Label">
      <div className="relative shrink-0 size-[24px]" data-name="Icon 24 swap">
        <div className="absolute inset-0 overflow-clip" data-name="Duseat-icons-24PT-Link">
          <Link />
        </div>
      </div>
      <p className="font-['TT_Commons:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#050b2e] text-[21px] text-center">Linked accounts</p>
    </div>
  );
}
...
function AppDeatils1() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="App deatils 2">
      <p className="font-['TT_Commons:Medium',sans-serif] leading-none not-italic relative shrink-0 text-[#050b2e] text-[23px]">Account</p>
      <Blocks />
    </div>
  );
}

function ShieldTick1() {
  return (
    <div className="absolute inset-[5.21%_9.44%_6.41%_9.47%]" data-name="Shield Tick">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.4621 21.2107">
        <g id="Shield Tick">
...
function AppDeatils2() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="App deatils 2">
      <p className="font-['TT_Commons:Medium',sans-serif] leading-none not-italic relative shrink-0 text-[#050b2e] text-[23px]">General</p>
      <Blocks1 />
    </div>
  );
}
