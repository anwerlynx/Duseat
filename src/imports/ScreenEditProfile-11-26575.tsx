import svgPaths from "./svg-vfxwm11t35";
...
function Edit() {
  return (
    <div className="absolute inset-[12.5%_20.46%_14.58%_20.83%]" data-name="Edit 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.5232 15.557">
        <g id="Edit 1">
          <path clipRule="evenodd" d={svgPaths.pdfadb60} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Header() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-center left-0 top-0 w-[393px]" data-name="Header">
      <StatusBar />
      <div className="bg-white content-stretch flex gap-[12px] h-[60px] items-center justify-center px-[16px] relative shrink-0 w-[393px]" data-name="Page bar">
        ...
        <div className="bg-[#01cbd2] content-stretch flex items-center justify-center p-[8px] relative rounded-[21.333px] shrink-0 size-[36px]" data-name="Button 3">
          <div className="overflow-clip relative shrink-0 size-[21.333px]" data-name="Duseat-icons-24PT-Edit 1">
            <Edit />
          </div>
          <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_-1px_4px_0px_#00a2a8,inset_0px_4px_4px_0px_rgba(255,255,255,0.25)]" />
        </div>
    ...
    <div className="flex-[1_0_0] h-[56px] min-h-px min-w-px relative rounded-[12px]" data-name="Field / First_Name">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center leading-none not-italic px-[10px] relative size-full whitespace-pre-wrap">
          <p className="font-['TT_Commons:Medium',sans-serif] relative shrink-0 text-[#050b2e] text-[12px] w-full">First name</p>
          <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] w-full">Anwar</p>
        </div>
      </div>
    </div>
  );
...
function FieldLastName() {
  return (
    <div className="flex-[1_0_0] h-[56px] min-h-px min-w-px relative rounded-[12px]" data-name="Field / Last_Name">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center leading-none not-italic px-[10px] relative size-full whitespace-pre-wrap">
          <p className="font-['TT_Commons:Medium',sans-serif] relative shrink-0 text-[#050b2e] text-[12px] w-full">Last name</p>
          <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] w-full">Hosny</p>
        </div>
      </div>
    </div>
  );
...
function FieldEmail() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[12px]" data-name="Field / Email">
      <div aria-hidden="true" className="absolute border border-[#999] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center leading-none not-italic px-[10px] py-[12px] relative w-full whitespace-pre-wrap">
          <p className="font-['TT_Commons:Medium',sans-serif] relative shrink-0 text-[#050b2e] text-[12px] w-full">Subtitle</p>
          <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] w-full">{`Helps investors achieve 7–9% annual ROI in Dubai Hills & Downtown`}</p>
        </div>
      </div>
    </div>
  );
...
function Email() {
  return (
    <div className="content-stretch flex items-center py-[7px] relative shrink-0 w-full" data-name="Email">
      <FieldEmail />
    </div>
  );
}
...
function CCode() {
  return (
    <div className="content-stretch flex gap-[4px] h-[56px] items-center px-[10px] relative rounded-[12px] shrink-0" data-name="C/code">
      ...
      <div className="flex items-center justify-center relative shrink-0 size-[32px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21.59375" } as React.CSSProperties}>
...
function FieldPhoneNumber() {
  return (
    <div className="flex-[1_0_0] h-[56px] min-h-px min-w-px relative rounded-[12px]" data-name="Field / Phone_Number">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center leading-none not-italic px-[10px] relative size-full whitespace-pre-wrap">
          <p className="font-['TT_Commons:Medium',sans-serif] relative shrink-0 text-[#050b2e] text-[12px] w-full">Phone number</p>
          <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] w-full">+201017130116</p>
        </div>
      </div>
    </div>
  );
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full">
      <p className="font-['TT_Commons:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#999] text-[16px]">Male</p>
      <div className="flex items-center justify-center relative shrink-0 size-[32px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21.59375" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="relative size-[32px]" data-name="Duseat-icons-24PT-Left 2">
            <Left2 />
...
function FieldGender() {
  return (
    <div className="content-stretch flex flex-col h-[56px] items-start justify-center px-[10px] relative rounded-[12px] shrink-0" data-name="Field / Gender">
      <div aria-hidden="true" className="absolute border border-[#999] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['TT_Commons:Medium',sans-serif] leading-none not-italic relative shrink-0 text-[#050b2e] text-[12px] w-full whitespace-pre-wrap">Gender</p>
      <Frame1 />
    </div>
  );
}
...
function FieldBithday() {
  return (
    <div className="flex-[1_0_0] h-[56px] min-h-px min-w-px relative rounded-[12px]" data-name="Field / Bithday">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center leading-none not-italic px-[10px] relative size-full whitespace-pre-wrap">
          <p className="font-['TT_Commons:Medium',sans-serif] relative shrink-0 text-[#050b2e] text-[12px] w-full">Birthday</p>
          <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] w-full">1/1/2001</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="flex-[1_0_0] h-[56px] min-h-px min-w-px relative rounded-[12px]" data-name="Field / Email">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center leading-none not-italic px-[10px] relative size-full whitespace-pre-wrap">
          ...
          <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] w-full">anwerhosney@gmail.com</p>
        </div>
      </div>
    </div>
  );
...
function FieldAddress() {
  return (
    <div className="flex-[1_0_0] h-[56px] min-h-px min-w-px relative rounded-[12px]" data-name="Field / Address">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center leading-none not-italic px-[10px] relative size-full whitespace-pre-wrap">
          <p className="font-['TT_Commons:Medium',sans-serif] relative shrink-0 text-[#050b2e] text-[12px] w-full">Adress</p>
          <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] w-full">Egypt , Kafr-elshiekh</p>
        </div>
      </div>
    </div>
  );
...
function FieldUsername() {
  return (
    <div className="flex-[1_0_0] h-[56px] min-h-px min-w-px relative rounded-[12px]" data-name="Field / Username">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center leading-none not-italic px-[10px] relative size-full whitespace-pre-wrap">
          <p className="font-['TT_Commons:Medium',sans-serif] relative shrink-0 text-[#050b2e] text-[12px] w-full">Username</p>
          <p className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] w-full">anwerhosney</p>
        </div>
      </div>
    </div>
  );
...
function FieldEmail2() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[12px] self-stretch" data-name="Field / Email">
      <div aria-hidden="true" className="absolute border border-[#999] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center leading-none not-italic px-[10px] py-[16px] relative size-full whitespace-pre-wrap">
          <p className="font-['TT_Commons:Medium',sans-serif] relative shrink-0 text-[#050b2e] text-[12px] w-full">Description</p>
          <div className="font-['TT_Commons:Regular',sans-serif] relative shrink-0 text-[#999] text-[16px] w-full">
...
function Fields1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Fields">
      <Email2 />
    </div>
  );
}
...
function PersonalInfo1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Personal_Info">
      <p className="font-['TT_Commons:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#666] text-[21px] w-full whitespace-pre-wrap">{`Bio & Specializations`}</p>
      <Fields1 />
    </div>
  );
}
...
function PersonalDetails() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] items-center left-[17px] top-[137px] w-[361px]" data-name="Personal_Details">
      <div className="absolute h-[80px] left-[-16px] top-[-31px] w-[393px]" data-name="Cover">
