import svgPaths from "./svg-4shfp5nj1x";
...
import { imgContents, imgFlag } from "./svg-dc15s";
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col font-['TT_Commons:Regular',sans-serif] gap-[24px] items-start justify-center leading-none not-italic py-[12px] relative shrink-0 text-[21px] w-[337px] whitespace-pre-wrap">
      <p className="relative shrink-0 text-[#050b2e] w-full" dir="auto">
        About this account
      </p>
      <p className="relative shrink-0 text-[#050b2e] w-full" dir="auto">
        About this account
      ...
      <p className="relative shrink-0 text-[#be1a0e] w-full" dir="auto">
        Report
      </p>
    </div>
  );
...
function DeleteAccount() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f8f8f8] bottom-0 content-stretch flex flex-col gap-[12px] items-center left-1/2 pb-[32px] pt-[16px] px-[16px] rounded-tl-[16px] rounded-tr-[16px] w-[393px]" data-name="Delete account">
      <Frame12 />
      <Frame10 />
    </div>
  );
    ...
    <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[32px_24px]" data-name="contents" style={{ maskImage: `url('${imgContents}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.4286 21.4286">
        <g id="contents">
          ...
          <mask height="22" id="mask0_11_26330" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="22" x="0" y="0">
            <path clipRule="evenodd" d="M0 0V21.4286H21.4286V0H0Z" fill="var(--fill-0, white)" fillRule="evenodd" id="background_2" />
          </mask>
          <g mask="url(#mask0_11_26330)">
...
function Plans() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="Plans">
      <div className="content-stretch flex items-start relative shrink-0" data-name="tags base">
        <div className="bg-[#ccfdff] content-stretch flex gap-[6px] items-center justify-center pl-[6px] pr-[8px] py-[2px] relative rounded-[16px] shrink-0" data-name="tags base">
          <div className="overflow-clip relative shrink-0 size-[8px]" data-name="_Dot">
            <div className="absolute left-px size-[6px] top-px" data-name="Dot">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
                <circle cx="3" cy="3" fill="var(--fill-0, #01CBD2)" id="Dot" r="3" />
              </svg>
            </div>
          </div>
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[#019398] text-[12px] text-center">New request</p>
        </div>
      </div>
    </div>
  );
...
function Information() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Information">
      <div className="-translate-x-1/2 absolute h-[80px] left-1/2 top-[-29px] w-[393px]" data-name="Cover">
...
function Experience() {
  return (
    <div className="bg-[#f9f9f9] content-stretch flex flex-col gap-[4px] h-[70px] items-center justify-center px-[12px] py-[24px] relative rounded-[12px] shrink-0 w-[110px]" data-name="Experience">
      ...
      <p className="font-['TT_Commons:Medium',sans-serif] leading-none not-italic relative shrink-0 text-[21px] text-black text-center w-full whitespace-pre-wrap">2.4M</p>
      <p className="font-['TT_Commons:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#666] text-[14px] text-center tracking-[-0.14px] w-full whitespace-pre-wrap">Avg client budget</p>
    </div>
  );
}
...
function AvgRate() {
  return (
    <div className="bg-[#f9f9f9] content-stretch flex flex-col gap-[4px] h-[70px] items-center justify-center px-[12px] py-[24px] relative rounded-[12px] shrink-0 w-[110px]" data-name="Avg rate">
      <div aria-hidden="true" className="absolute border border-[rgba(115,115,115,0.09)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['TT_Commons:Medium',sans-serif] leading-[0] not-italic relative shrink-0 text-[0px] text-black text-center w-full whitespace-pre-wrap">
        <span className="leading-none text-[21px]">4.9</span>
        <span className="font-['TT_Commons:Regular',sans-serif] leading-none text-[#666] text-[16px]">/5.0</span>
      </p>
      <p className="font-['TT_Commons:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#666] text-[14px] text-center tracking-[-0.14px] w-full whitespace-pre-wrap">Reliability</p>
    </div>
  );
}
...
function AvgRate1() {
  return (
    <div className="bg-[#f9f9f9] content-stretch flex flex-col gap-[4px] h-[70px] items-center justify-center px-[12px] py-[24px] relative rounded-[12px] shrink-0 w-[110px]" data-name="Avg rate">
      <div aria-hidden="true" className="absolute border border-[rgba(115,115,115,0.09)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['TT_Commons:Medium',sans-serif] leading-none not-italic relative shrink-0 text-[21px] text-black text-center w-full whitespace-pre-wrap">15</p>
      <p className="font-['TT_Commons:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#666] text-[14px] text-center tracking-[-0.14px] w-full whitespace-pre-wrap">Accepted offers</p>
    </div>
  );
}
...
function Bio() {
  return (
    <div className="backdrop-blur-[25px] bg-white relative rounded-[12px] shrink-0 w-full" data-name="Bio">
...
function BioSpecializations() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Bio & Specializations">
      <p className="font-['TT_Commons:Medium',sans-serif] leading-none not-italic relative shrink-0 text-[#050b2e] text-[21px] w-full whitespace-pre-wrap" dir="auto">{`Bio & Specializations`}</p>
      <Bio />
    </div>
  );
}
            ...
            <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[32px_24px]" data-name="contents" style={{ maskImage: `url('${imgFlag}')` }}>
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 24">
                <g id="contents">
                  ...
                  <mask height="24" id="mask0_11_26260" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="32" x="0" y="0">
                    <path clipRule="evenodd" d="M0 0V24H32V0H0Z" fill="var(--fill-0, white)" fillRule="evenodd" id="background_2" />
                  </mask>
                  <g mask="url(#mask0_11_26260)">
...
function CoreExpertise() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-full" data-name="Core Expertise">
      <p className="font-['TT_Commons:Medium',sans-serif] leading-none min-w-full not-italic relative shrink-0 text-[#050b2e] text-[21px] w-[min-content] whitespace-pre-wrap" dir="auto">
        Recent requests
      </p>
...
function Avatar() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] items-center left-[16px] top-0 w-[361px]" data-name="Avatar">
      <Content1 />
      <Text />
    </div>
  );
...
function Content() {
  return (
    <div className="-translate-x-1/2 absolute h-[818px] left-1/2 top-[130px] w-[393px]" data-name="Content">
      <Avatar />
    </div>
  );
}
...
function Frame11() {
  return <div className="absolute backdrop-blur-[2px] bg-[rgba(6,14,60,0.17)] h-[898px] left-0 top-[107px] w-[393px]" />;
}

export default function InvestorProfileMenuAgent() {
  return (
    <div className="bg-white relative size-full" data-name="Investor profile menu (Agent)">
