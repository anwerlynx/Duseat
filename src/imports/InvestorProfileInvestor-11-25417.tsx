import svgPaths from "./svg-n850r80kq1";
...
import { imgContents, imgFlag } from "./svg-81n2p";
    ...
    <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[32px_24px]" data-name="contents" style={{ maskImage: `url('${imgContents}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.4286 21.4286">
        <g id="contents">
          ...
          <mask height="22" id="mask0_11_26178" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="22" x="0" y="0">
            <path clipRule="evenodd" d="M0 0V21.4286H21.4286V0H0Z" fill="var(--fill-0, white)" fillRule="evenodd" id="background_2" />
          </mask>
          <g mask="url(#mask0_11_26178)">
...
function Bio() {
  return (
    <div className="backdrop-blur-[25px] content-stretch flex flex-col items-start relative rounded-[12px] shadow-[0px_1px_5px_0px_rgba(0,0,0,0.08)] shrink-0 w-[355px]" data-name="Bio">
      <div className="font-['Lato:Regular','Noto_Sans:Regular',sans-serif] leading-[18px] relative shrink-0 text-[#666] text-[12px] w-[296px] whitespace-pre-wrap" style={{ fontVariationSettings: "\'CTGR\' 0, \'wdth\' 100, \'wght\' 400" }}>
...
function Avatar() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] items-start left-0 top-0 w-[355px]" data-name="Avatar">
      <Content1 />
      <Text />
    </div>
  );
            ...
            <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[32px_24px]" data-name="contents" style={{ maskImage: `url('${imgFlag}')` }}>
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 24">
                <g id="contents">
                  ...
                  <mask height="24" id="mask0_11_26110" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="32" x="0" y="0">
                    <path clipRule="evenodd" d="M0 0V24H32V0H0Z" fill="var(--fill-0, white)" fillRule="evenodd" id="background_2" />
                  </mask>
                  <g mask="url(#mask0_11_26110)">
...
function Request() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[12px] items-center left-[-19px] px-[16px] py-[24px] top-[367px] w-[393px]" data-name="Request">
...
function Content() {
  return (
    <div className="absolute h-[844px] left-[19px] top-[130px] w-[355px]" data-name="Content">
      <Avatar />
      <Request />
    </div>
  );
...
function Frame17() {
  return (
    <div className="absolute backdrop-blur-[2px] bg-[rgba(6,14,60,0.17)] h-[898px] left-0 overflow-clip top-[89px] w-[393px]">
      <DeleteAccount />
    </div>
  );
}
